...
class _AnggotaNavigationScreenState extends State<AnggotaNavigationScreen> {
  ...
  void initState() {
    ...
    // Listen for FCM messages to handle fire status updates
      ...
      if (message.data.isNotEmpty) {
        try {
          ...
          if (data['status'] == 'padam') {
            // Show notification and close navigation if fire is extinguished
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            FlutterMap(
              ...
              children: [
                ...
                TileLayer(
                  ...
                  additionalOptions: {'accessToken': dotenv.env['MAPBOX_ACCESS_TOKEN'] ?? ''},
                ),
                // Route polyline for fire path
                ...
                // Marker for assigned neutralization point
            ...
            // Display assigned point information
            if (assignedPointLocation != null)
              Positioned(
                bottom: 20,
                left: 20,
